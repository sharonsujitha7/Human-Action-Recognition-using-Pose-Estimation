...
def get_dst_folder_name(src_data_type, src_data_path):
    ...
    if src_data_type == "E:\Pose_Estimation\data_test\exercise.avi":  # /root/data/video.avi --> video
        folder_name = os.path.basename(src_data_path).split(".")[-2]

    elif src_data_type == "E:\Pose_Estimation\data_test":  # /root/data/video/ --> video
